...
<div class="relative -mt-16 w-full h-80 md:h-[60vh] bg-cover bg-center"
   ...
   <div class="flex justify-end mb-4 mt-20 pr-40">
     ...
     <div class="grid grid-cols-3 gap-x-6 gap-y-32 px-36 py-36">
        <div class="relative rounded-lg overflow-hidden shadow-md">
            <img src="/img/kartini1.jpg" alt="Hari Kartini" class="w-full h-40 object-cover rounded-lg" />
            <div class="absolute bottom-0 w-full bg-[#2D336B] text-white text-center py-2 font-semibold rounded-b-lg">Hari Kartini</div>
        </div>
        <div class="relative rounded-lg overflow-hidden shadow-md">
            <img src="/img/ksn.jpg" alt="Kompetensi Sains Nasional" class="w-full h-40 object-cover rounded-lg" />
            <div class="absolute bottom-0 w-full bg-[#2D336B] text-white text-center py-2 font-semibold rounded-b-lg">Kompetensi Sains Nasional</div>
        </div>
        <div class="relative rounded-lg overflow-hidden shadow-md">
            <img src="/img/juara.jpg" alt="Buka Bersama" class="w-full h-40 object-cover rounded-lg" />
            <div class="absolute bottom-0 w-full bg-[#2D336B] text-white text-center py-2 font-semibold rounded-b-lg">Buka Bersama</div>
        </div>
        <div class="relative rounded-lg overflow-hidden shadow-md">
            <img src="/img/parajuara.png" alt="Para Juara" class="w-full h-40 object-cover rounded-lg" />
            <div class="absolute bottom-0 w-full bg-[#2D336B] text-white text-center py-2 font-semibold rounded-b-lg">Para Juara</div>
        </div>
        <div class="relative rounded-lg overflow-hidden shadow-md">
            <img src="/img/hadiah.jpg" alt="Pesantren Kilat" class="w-full h-40 object-cover rounded-lg" />
            <div class="absolute bottom-0 w-full bg-[#2D336B] text-white text-center py-2 font-semibold rounded-b-lg">Pesantren Kilat</div>
        </div>
        <div class="relative rounded-lg overflow-hidden shadow-md">
  ...
  <div class="flex items-center space-x-2 mt-12 ml-36 mb-6">
        ...
        <a href="#" class="bg-[#E6EAF7] text-[#2D336B] font-bold px-4 py-2 rounded-full shadow-md">Foto</a>
    </div>
