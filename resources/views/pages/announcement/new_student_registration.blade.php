<x-layouts>
    ...
    <div class="flex flex-col items-center p-4">
        ...
        <div class="flex justify-center mt-12">
            <img src="/img/ppdb.jpeg" alt="Pendaftaran PPDB" class="w-full h-auto max-w-2xl rounded-lg shadow-xl">
        </div>

        {{-- Link Pendaftaran --}}
        <div class="mt-10 text-center">
            <h3>Pendaftaran Peserta Didik Baru SDN Bandarharjo 01 Kota Semarang Tahun Ajaran 2025/2026 dapat dilakukan
                dengan klik <b>'Daftar'</b> di bawah ini</h3>
    ...
    <!-- Breadcrumb -->
    <div class="flex items-center mb-10 ml-24 space-x-2">
        <x-breadcrumb />
    </div>
    <x-layouts.footer />
</x-layouts>
