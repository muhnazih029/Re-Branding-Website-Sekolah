    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
        ...
        <div class="bg-[#2D336B] text-white p-10 rounded-2xl shadow-md border-2 border-[#6B9BF3]">
            <div class="flex justify-center mb-4">
                <img src="img/map.png" alt="Lokasi" class="w-10 h-10">
            </div>
            <h2 class="text-xl font-semibold">ALAMAT</h2>
            <p class="text-sm mt-3">Jalan Cumi-Cumi Raya No 2, Bandarharjo, <br> Kec. Semarang Utara, Kota Semarang, <br> Provinsi Jawa Tengah</p>
        </div>

        <!-- CALL SERVICE -->
        <div class="bg-[#2D336B] text-white p-10 rounded-2xl shadow-md border-2 border-[#6B9BF3]">
            <div class="flex justify-center mb-4">
                <img src="img/call.png" alt="Call Service" class="w-10 h-10">
            </div>
            <h2 class="text-xl font-semibold">CALL SERVICE</h2>
            <p class="text-sm mt-3">E-mail: <a href="mailto:sdnbandarharjo01@gmail.com" class="underline">sdnbandarharjo01@gmail.com</a><br> 
                Telp: 024-3551189</p>
        </div>
        ...
        <div class="bg-[#2D336B] text-white p-10 rounded-2xl shadow-md border-2 border-[#6B9BF3]">
            <div class="flex justify-center mb-4">
                <img src="img/jam.png" alt="Jam Kerja" class="w-10 h-10">
            </div>
            <h2 class="text-xl font-semibold">JAM KERJA</h2>
            <p class="text-sm mt-3">Senin-Kamis: 08.00 - 15.00 WIB <br> Jumat: 08.00 - 11.30 WIB <br> Sabtu-Minggu: Libur</p>
        </div>
    </div>
</div>
...
<div class="flex justify-center items-center min-h-screen px-[1cm]">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-[900px]">
        <h2 class="text-[#2D336B] text-center text-2xl font-bold mb-6" style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3);">
            PENGADUAN
        </h2>
        <form class="space-y-4">
            <div class="flex items-center">
                <label class="text-[#2D336B] font-semibold text-lg w-[28%] text-right pr-8">Nama :</label>
                <input type="text" class="w-[65%] px-4 py-3 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D336B]">
            </div>
            <div class="flex items-center">
                <label class="text-[#2D336B] font-semibold text-lg w-[28%] text-right pr-8">E-mail :</label>
                <input type="email" class="w-[65%] px-4 py-3 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D336B]">
            </div>
            <div class="flex items-center">
            ...
            <div class="flex items-start">
                ...
                <textarea class="w-[65%] px-4 py-3 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2D336B]" rows="6"></textarea>
            </div>
            <div class="flex justify-end pr-6">
                <button type="submit" class="bg-[#6B73D3] text-white font-bold py-2 px-8 rounded-full hover:bg-[#525AA1] transition">
                    Kirim
                </button>
            </div>
        </form>
