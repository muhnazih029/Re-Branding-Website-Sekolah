    ...
    <div class="w-full max-w-4xl p-4 mx-auto mt-6 rounded-lg">
        ...
        <div class="overflow-x-auto">
            <table class="w-full border border-collapse border-blue-500 bg-blue-50">
                ...
                <tbody>
                    <tr>
                        <td class="h-10 px-3 py-2 text-sm text-center border-2 border-blue-500 md:text-base">1</td>
                        <td class="px-3 py-2 text-sm break-words border-2 border-blue-500 md:text-base">
                            Tugas merubah RUU TNI dan mengembalikannya seperti semula
                        </td>
                        <td class="px-3 py-2 text-sm break-words border-2 border-blue-500 md:text-base">
                            Tugas ini harus dikerjakan klo ga berarti u ga peduli.
                        </td>
                    </tr>
                </tbody>
            </table>
