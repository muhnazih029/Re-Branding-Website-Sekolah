{{ 'ini halaman video pembelajaran sekolah' }}
...
<body class="bg-gray-100 font-poppins pt-[190px]">
    ...
    <div class="min-h-screen p-8">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <!-- Video Card -->
            <div>
                <iframe class="w-full h-64 rounded-md" src="https://www.youtube.com/embed/QCdDN1T1vdQ" allowfullscreen></iframe>
    ...
    <div class="flex items-center mt-10 mb-10 ml-8 space-x-2">
        ...
        <span class="text-[#2D336B]"></span>
        <a href="/video-pembelajaraan"
                class="bg-[#E6EAF7] text-[#2D336B] font-bold px-4 py-2 rounded-full shadow-md">Video Pembelajaran</a>
        <span class="text-[#2D336B]"></span>
    </div>
