...
<body class="bg-gray-100 font-poppins pt-[190px]">
    ...
    <div class="flex flex-col items-center mt-10">
        ...
        <!-- Judul -->
        <h1 class="text-2xl font-bold text-center">KURIKULUM SDN BANDARHARJO 01 KOTA SEMARANG</h1>
    </div>

    <!-- Deskripsi -->
    <div class="mx-auto mt-6 w-[800px] text-justify text-lg">
        <p>Saat ini kami telah melaksanakan Kurikulum 2013 sejak Tahun Pelajaran 2017/2018.</p>

        <h2 class="mt-4 font-bold">Prinsip Kurikulum</h2>
        <p>Kurikulum SDN Bandarharjo 01 Semarang mengacu kepada Standar Nasional Pendidikan untuk mencapai tujuan pendidikan nasional. Standar Nasional Pendidikan terdiri dari:</p>
        ...
        <h2 class="mt-4 font-bold">Pengembangan Pendidikan</h2>
        <p>Kurikulum sekolah ini disusun agar peserta didik dapat memperoleh kesempatan pembelajaran yang:</p>
        <ul class="mt-2 ml-8 list-disc">
            <li>Memungkinkan peserta didik belajar sesuai dengan potensi, minat, dan bakatnya.</li>
            <li>Mengintegrasikan pendidikan karakter dan nilai-nilai luhur yang berakar dari Pancasila.</li>
            <li>Mengembangkan keterampilan abad 21 untuk berbagai aspek kehidupan.</li>
        </ul>
    </div>
    <br>
    ...
    <div class="flex items-center mt-10 mb-10 ml-8 space-x-2">
        ...
        <a href="/kurikulum/kurikulum-sekolah"
                class="bg-[#E6EAF7] text-[#2D336B] font-bold px-4 py-2 rounded-full shadow-md">Kurikulum Sekolah</a>
    </div>
