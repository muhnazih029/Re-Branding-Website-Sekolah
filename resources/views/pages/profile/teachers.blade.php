                ...
                <div style="background-color: #E6EAF7; color:#2D336B;"
                    ...
                    <ul class="space-y-2">
                        <li><a href="/profile/visi-misi" class="block text-[#7886C7] hover:text-blue-900 font-semibold">Visi Misi
                                Sekolah</a></li>
                        <li><a href="https://referensi.data.kemdikbud.go.id/tabs.php?npsn=20329336" class="block text-[#7886C7] hover:text-blue-900 font-semibold">NPSN</a>
                        </li>
                        <li><a href="/profile/sejarah-sekolah" class="block text-[#7886C7] hover:text-blue-900 font-semibold">Sejarah
                                Sekolah</a></li>
                        <li><a href="/profile/pendidik" class="block text-[#7886C7] hover:text-blue-900 font-semibold">Pendidik
                                dan Tenaga Kependidikan</a></li>
                        <li><a href="/profile/peserta-didik" class="block text-[#7886C7] hover:text-blue-900 font-semibold">Peserta
                                Didik</a></li>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-4">
                            ...
                            <div
                                ...
                                <!-- Kotak Foto -->
                                <div
                                    class="w-32 h-35 md:w-32 md:h-35 bg-gray-300 overflow-hidden mb-4 md:mb-0 md:mr-5">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="mt-3">
                                        <table class="w-full">
                                            ...
                                            <tr>
                                                <th class="text-left font-semibold py-2 whitespace-nowrap">Jenis
                                                    Kelamin :
                                                    Perempuan</th>
                                            </tr>
                                            <tr>
                                                <th class="text-left font-semibold py-2 whitespace-nowrap">Jabatan :
                                                    Kepala
                                                    Sekolah</th>
                                            </tr>
                                        </table>
